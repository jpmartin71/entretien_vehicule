				...
				<form class="form_operation" method="post" action='<?php echo $action; ?>'>
					...
					<fieldset>
						...
						<div class="form_operation <?php if(isset($erreur_view['periodicite_tps']))echo 'erreur';?>">
							<div class="form_operation">
								...
								<input type="number" name="periodicite_tps" id="periodicite_tps" value="<?php echo $operation['periodicite_tps'];?>" <?php echo $enable_input['periodicite_tps']; ?>>
							</div>
							<div class="form_operation">
								<input type="checkbox" onchange="checkbox_inib_periodicite_tps()" name="inib_periodicite_tps" id="inib_periodicite_tps" <?php echo $enable_input['inib_periodicite_tps']; ?> <?php if(isset($_POST['inib_periodicite_tps']))echo 'checked';?>/>
					...
					<fieldset>
						...
						<div class="form_operation <?php if(isset($erreur_view['effectuee_km']))echo 'erreur';?>">
							...
							<input type="number" name="effectuee_km" id="effectuee_km" value="<?php echo $operation['effectuee_km'];?>" <?php echo $enable_input['effectuee_km']; ?>>
						</div>
						...
						<div class="form_operation <?php if(isset($erreur_view['effectuee_date']))echo 'erreur';?>">
							...
							<input type="date" name="effectuee_date" id="effectuee_date" value="<?php if($operation['effectuee_date']!=null)echo date_create($operation['effectuee_date'])->format('Y-m-d');?>" <?php echo $enable_input['effectuee_date']; ?>>
							</br>
						</div>
					...
					<fieldset>
						...
						<div class="form_operation">
							...
							<input type="number" name="echeance_km" id="echeance_km" value="<?php echo $operation['echeance_km'];?>"  <?php echo $enable_input['echeance_km']; ?>>
						</div>
						<div class="form_operation">
							<label for="echeance_date">Prochaine échéance (date)</label>
							<input type="date" name="echeance_date" id="echeance_date" value="<?php if($operation['echeance_date']!=null)echo date_create($operation['echeance_date'])->format('Y-m-d');?>"  <?php echo $enable_input['echeance_date']; ?>>
						</div>
					</fieldset>
					<fieldset>
